...
export default function Home() {
    ...
    return (
        <body className={`${fontPoppins.variable} ${fontAtacama.variable} ${fontCarattere.variable} ${fontAnagram.variable} `}>
            ...
            {/* <div className="flex justify-center fixed sm:bottom-0 -bottom-14 sm:right-0">
                <Image src={SYPHYR} alt="SYPHYR" className="w-[90vw] sm:w-[40vw] flex justify-center items-center bg-center bg-cover object-cover rotate-90"/>
            </div> */}

            {/* <div className="fixed bottom-0 bg-red-400 -right-20 flex justify-center">
                <Image src={SYPHYR} alt="SYPHYR" className="w-[90vw] sm:w-[40vw] flex justify-center items-center bg-center bg-cover object-cover rotate-90"/>
            </div> */}
